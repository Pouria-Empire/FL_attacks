...
def gradinversion_group_attack(
    ...
    # --- THE FIX for COLOR INVERSION: Optimize a "pre-image" ---
    ...
    dummy_model = torch.nn.Sequential(
        torch.nn.Linear(784, 64), torch.nn.ReLU(), torch.nn.Linear(64, 10), torch.nn.LogSoftmax(dim=1)
    )
    ...
    for it in range(iterations):
        ...
        # Apply sigmoid to all candidates before calculating consensus
